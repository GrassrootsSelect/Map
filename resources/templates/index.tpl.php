...
?>
<script type="text/javascript" src="<?=($data["baseUrl"])?>js/index.js?a"></script>
    <link rel="stylesheet" href="<?=($data["baseUrl"])?>css/index.css" type="text/css" media="all" />

</div><?php //ending .header wrapper established when including WP header ?>
    ...
    <div class="clear"></div>
</div><?php //ending #page-wrapper established when including WP header ?>
<?php
